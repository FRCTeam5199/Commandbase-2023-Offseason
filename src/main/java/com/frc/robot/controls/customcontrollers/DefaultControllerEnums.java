...
public class DefaultControllerEnums {
    ...
    public enum XboxAxes implements ControllerInterfaces.IContinuousInput {
        LEFT_JOY_X(0, Constants.XBOX_CONTROLLER_DEADZONE), LEFT_JOY_Y(1, Constants.XBOX_CONTROLLER_DEADZONE), LEFT_TRIGGER(2, 0), RIGHT_TRIGGER(3, 0), RIGHT_JOY_X(4, Constants.XBOX_CONTROLLER_DEADZONE), RIGHT_JOY_Y(5, Constants.XBOX_CONTROLLER_DEADZONE);
