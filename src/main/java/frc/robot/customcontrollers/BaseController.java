...
import frc.robot.customcontrollers.DefaultControllerEnums.ButtonStatus;
import frc.robot.customcontrollers.DefaultControllerEnums.RawCompassInput;
import frc.robot.customcontrollers.DefaultControllerEnums.ResolvedCompassInput;

import java.util.function.Function;

import static frc.robot.customcontrollers.ControllerInterfaces.*;
