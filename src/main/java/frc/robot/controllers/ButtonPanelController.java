...
public class ButtonPanelController extends BaseController {
    ...
    public DefaultControllerEnums.ButtonStatus get(ControllerInterfaces.IDiscreteInput button) {
        if (button instanceof ButtonPanelButtons || button instanceof ControllerEnums.ButtonPanelTapedButtons || button instanceof ControllerEnums.ButtonPanelButtons2022 || button instanceof ControllerEnums.TCannonExtraButtons || button instanceof ControllerEnums.MidiController || button instanceof ControllerEnums.ButtonPanelButtonsPlacement2023 || button instanceof ControllerEnums.ButtonPanelButtonsElse2023)
